...
- **編號小節**（`## 1. ## 2. …`）：**高保真**——保留這份講義的**全部定義、命題/定理（含證明步驟）、演算法、例子（含具體數字）、直覺與備註**，依原講義小節結構排。**只壓縮冗語，不刪內容**；助教答得多細，取決於這裡留得多細。
- **數學符號、變數名保留原文**（inline LaTeX 可）。
- 講義**若有**具體或台灣脈絡例子才放；**不虛構**經濟事實/數據。
- **無頁數上限**（忠實壓縮而非摘要）；繁體中文台灣用語，原文措辭可保留。
...
- **作業 / 考古題 / 考試**：**保留完整題幹**——每題的具體數字、資料、假設、子題、配分都留下（學生問「第一題」時助教才講得出設定）；**僅排除解答、答案卷、計算過程與程式碼答案**（來源附解答框一律略去）。**誠信由行為政策把關（只給提示），不是靠刪資訊**。考古題全文是否讓學生看到，標「請老師確認」（有些老師不公開考古題）。
...
- **受評素材保留完整題幹、僅排除解答**——誠信由行為政策把關（只給提示），不是靠刪資訊。
