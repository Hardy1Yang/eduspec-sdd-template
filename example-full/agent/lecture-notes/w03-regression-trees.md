---
id: w03-regression-trees
title: 第三週：迴歸樹（Decision Trees for Prediction Problems）
week: 3
source_files:
  - w3-regression-trees.tex
last_updated: 2026-07-11
---

# 第三週：迴歸樹（Decision Trees for Prediction Problems）
...
Bias–Variance Trade-off 與 MSE 分解。
...
### 5.2 用交叉驗證（Cross-Validation）選深度
